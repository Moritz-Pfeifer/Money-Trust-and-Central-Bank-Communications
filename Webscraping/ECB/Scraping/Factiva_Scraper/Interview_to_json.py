...
allowed_names = ['Wim Duisenberg', 'Willem Duisenberg', 'Christian Noyer', 'Sirkka Hämäläinen', 'Eugenio Domingo Solans',
                 'Tommaso Padoa-Schioppa', 'Otmar Issing', 'Lucas Papademos', 'Jean-Claude Trichet',
                 'Gertrude Tumpel-Gugerell', 'José Manuel González-Paramo', 'González-Paramo',
                 'Lorenzo Bini Smaghi', 'Jürgen Stark']
