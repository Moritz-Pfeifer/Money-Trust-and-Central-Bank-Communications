...
def extract(url, section):
    ...
    section_code = {'reden': '729950', 'pressenotizen': '724000', 'interviews': '729904'}
...
if __name__ == '__main__':
    ...
    if len(args) != 2:
        print(
            'Incorrect format. The correct format is: python extract.py <section> where section could be one of them: pressenotizen,reden and interviews')
        exit()
    ...
    extract('https://www.bundesbank.de/de/presse/{}'.format(section_name.strip()), section_name.strip())
