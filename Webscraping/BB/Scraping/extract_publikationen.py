...
def extract(url, section):
    ...
    section_code = {'reden': '729950', 'pressenotizen': '724000', 'interviews': '729904', 'publikationen': '732090'}
...
if __name__ == '__main__':
    allowed_sections = ['reden', 'pressenotizen', 'interviews', 'publikationen']
    args = sys.argv
    if len(args) != 2:
        print(
            'Incorrect format. The correct format is: python extract.py <section> where section could be one of them: pressenotizen,reden,interviews, and publikationen')
        exit()
    ...
    extract('https://www.bundesbank.de/de/{}/suche/'.format(section_name.strip()), section_name.strip())
